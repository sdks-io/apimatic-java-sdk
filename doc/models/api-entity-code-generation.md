...
| `ApiEntityId` | `String` | Required | Unique API Entity Identifier | String getApiEntityId() | setApiEntityId(String apiEntityId) |
...
ApiEntityCodeGeneration apiEntityCodeGeneration = new ApiEntityCodeGeneration.Builder(
